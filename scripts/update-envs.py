...
apple_rc_key        = os.getenv('APPLE_REVENUE_CAT_KEY', '')
google_rc_key       = os.getenv('GOOGLE_REVENUE_CAT_KEY', '')
...
export const ENVIRONMENT = {{
  ...
  appleRevenueCatKey: "{apple_rc_key}",
  googleRevenueCatKey: "{google_rc_key}",
