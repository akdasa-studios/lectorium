...
from lectorium.transcripts import (
  transcript_enrich, transcript_enrich_chunk,
  transcript_split_into_chunks)
...
def transcript_proofread():
  ...
  #### Input File:
  - `library/tracks/{track_id}/artifacts/transcripts/{language}/{transcript_type}.json`: Extracted transcript

  #### Output:
  - `library/tracks/{track_id}/artifacts/transcripts/{language}/proofread.json`: Proofread transcript
  - `library/tracks/{track_id}/artifacts/transcripts/{language}/raw/chunks/proofread/{idx}.txt`: Proofread chunks
  """
  ...
  conf_result_path   = "{{ 'library/tracks/' ~ params.track_id ~ '/artifacts/transcripts/' ~ params.language ~ '/proofread.json' }}"
  conf_original_path = "{{ 'library/tracks/' ~ params.track_id ~ '/artifacts/transcripts/' ~ params.language ~ '/' ~ params.transcript_type ~ '.json' }}"
