...
def transcript_translate():
  ...
  #### Output:
  - `library/tracks/{track_id}/artifacts/transcripts/{language}/translated.json`: Translated transcript
  ...
  conf_result_path   = "{{ 'library/tracks/' ~ params.track_id ~ '/artifacts/transcripts/' ~ params.language_translate_into ~ '/translated.json' }}"
  conf_original_path = "{{ 'library/tracks/' ~ params.track_id ~ '/artifacts/transcripts/' ~ params.language_translate_from ~ '/' ~ params.transcript_type ~ '.json' }}"
