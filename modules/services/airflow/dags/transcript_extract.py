...
from lectorium.shared import (
  LANGUAGES_PARAMS, LANGUAGES_PARAMS_OPTIONAL, get_dag_run_id)
...
def transcript_extract():
  ...
  - `library/tracks/{track_id}/artifacts/transcripts/{language}/transcript.json`: Proofread or translated transcript
  """
