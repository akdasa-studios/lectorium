...
EXTRACT_METADATA_PROMPT_PREFIX = "lectorium::prompts::extract-metadata::"
...
Variable.setdefault(
  EXTRACT_METADATA_PROMPT_PREFIX + "en",
  """
  ...
  Use | as the delimiter. The verse number might be in the following format: BG 2.14, SB 1.2.3, CC Adi 1.2.3, etc. Return plain result. Do not add any comments from you.
  """,
  "Transript proofread prompt in English",
)

Variable.setdefault(
  EXTRACT_METADATA_PROMPT_PREFIX + "ru",
  """
