      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-purple max-w-none">
            ...
            <h2 className="text-xl font-semibold text-sadu-dark-purple mt-8 mb-4">Terms & Conditions</h2>
            <p className="text-gray-700 mb-4">
              These terms and conditions apply to the Listen to Sadhu app (hereby referred to as "Application") 
              for mobile devices that was created by Aleksey Leontev (hereby referred to as "Service Provider") as a Free service.
            </p>
            ...
            <h2 className="text-xl font-semibold text-sadu-dark-purple mt-8 mb-4">Third Party Services</h2>
            <p className="text-gray-700 mb-4">
            ...
            <ul className="list-disc pl-6 mb-4 text-gray-700">
              <li><a href="https://policies.google.com/terms" className="text-sadu-purple hover:underline" target="_blank" rel="noopener noreferrer">Google Play Services</a></li>
              <li><a href="https://sentry.io/terms/" className="text-sadu-purple hover:underline" target="_blank" rel="noopener noreferrer">Sentry</a></li>
            </ul>
            
            <h2 className="text-xl font-semibold text-sadu-dark-purple mt-8 mb-4">Disclaimers and Limitations</h2>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-4">
              ...
              terms still apply. Consequently, you may incur charges from your mobile provider for data usage during the connection 
              to the application, or other third-party charges. By using the application, you accept responsibility for any such charges, 
            ...
            <p className="text-gray-700 mb-4">
              ...
              strive to ensure that it is updated and accurate at all times, they do rely on third parties to provide information to them 
              so that they can make it available to you. The Service Provider accepts no liability for any loss, direct or indirect, that 
              you experience as a result of relying entirely on this functionality of the application.
            </p>
            
            <h2 className="text-xl font-semibold text-sadu-dark-purple mt-8 mb-4">Updates and Termination</h2>
            <p className="text-gray-700 mb-4">
              ...
              system version installed on your device. However, you agree to always accept updates to the application when offered to you. 
            ...
            <h2 className="text-xl font-semibold text-sadu-dark-purple mt-8 mb-4">Changes to These Terms and Conditions</h2>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-4">
              These terms and conditions are effective as of 2025-05-10
            </p>
            ...
            <p className="text-gray-700 mb-4">
              ...
              the Service Provider at <a href="mailto:contact@akdasa.studio" className="text-sadu-purple hover:underline">contact@akdasa.studio</a>.
            </p>
          </div>
        </div>
      </main>
