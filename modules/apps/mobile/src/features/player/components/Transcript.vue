...
import TranscriptDialog from './Transcript/TranscriptDialog.vue'
import { default as LanguageSelector, type TranscriptLanguage } from './LanguageSelector.vue'
import { default as TranscriptText, type TranscriptBlock, type TranscriptSection } from './Transcript/TranscriptText.vue'
